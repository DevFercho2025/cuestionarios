    ...
    <div class="layout-container">
        <div class="form-section card">
            <div class="card-content">
                <h4 class="form-title center-align">Registro de la Evaluación</h4>
                ...
                <form action="{{ route('guardar.candidato') }}" method="POST" id="registro-form">
                    @csrf
                    ...
                    <div class="seccion-form activa">
                        <div class="input-field">
                            ...
                            <label for="cargo"><span class="asterisco-obligatorio">*</span>Vacante a la que aplica</label>
