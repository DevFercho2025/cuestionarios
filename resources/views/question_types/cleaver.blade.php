@php
    ...
    $glosario = [
                ...
                7 => [
                    'Fuerza de voluntad' => 'con convencimiento interno y tenacidad para alcanzar un objetivo',
                ...
                8 => [
                    'Confiado' => 'satisfecho de sí mismo, crédulo, ingenuo',
                ...
                12 => [
                    ...
                    'Bondadoso' => 'que se inclina a hacer el bien, amable',
                ...
                14 => [
                    'Respetuoso' => 'que toma en cuenta y acata las reglas',
                ...
                17 => [
                    ...
                    'Confianza en sí mismo' => 'que se siente seguro y satisfecho con su manera de ser y actuar',
                ...
                18 => [
                    ...
                    'Pacífico' => 'tranquilo, que está en paz, que evita peleas',
                    'Positivo' => 'que muestra lo que es cierto, real, auténtico',
                ],
                19 => [
                ...
                21 => [
                    ...
                    'Controlado' => 'que se domina y frena a sí mismo',
...
<div class="glosario mb-4">
    <ul class="collapsible">
        <li>
            <div class="collapsible-header"><i class="material-icons">library_books</i>Glosario</div>
            <div class="collapsible-body">
                @foreach ($glosario as $bloqueNum => $terminos)
                    <h6>Bloque {{ $bloqueNum }}</h6>
                    <ul class="browser-default">
                        @foreach ($terminos as $termino => $definicion)
                            <li><strong>{{ $termino }}</strong>: {{ $definicion }}</li>
                        @endforeach
                    </ul>
                @endforeach
            </div>
